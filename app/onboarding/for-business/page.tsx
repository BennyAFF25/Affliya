  ...
  useEffect(() => {
    async function finish() {
      try {
        ...
        console.warn(
          "[business onboarding redirect] failed to mark complete",
          err,
        );
      } finally {
      ...
      <div className="flex flex-col items-center gap-4 rounded-3xl border border-white/10 bg-black/40 px-6 py-10 text-center shadow-[0_25px_70px_rgba(0,0,0,0.55)]">
        ...
        <div>
          ...
          <h1 className="mt-2 text-2xl font-semibold">
            Heading to your business dashboard
          </h1>
          <p className="mt-2 text-sm text-white/65">
            We replaced the legacy onboarding steps with the in-app flow. Sit
