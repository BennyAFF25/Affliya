...
export default function BusinessSupportPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0e0e0e] text-white px-10 py-12">
      ...
      <div className="space-y-4 mb-12">
        {faqs.map((faq, index) => (
          <div key={index} className="border border-[#00C2CB]/30 rounded-xl bg-[#1a1a1a] shadow">
            <button
      ...
      {/* Contact Card */}
      <div className="bg-[#1a1a1a] border border-[#00C2CB]/30 rounded-xl p-6 shadow max-w-xl mx-auto">
        <h2 className="text-xl font-semibold text-[#00C2CB] mb-2">Still need help?</h2>
        <p className="text-sm text-gray-300 mb-4">Send us a message and our support team will reach out.</p>

        <textarea
          placeholder="Write your message here..."
          className="w-full border border-gray-700 bg-[#0e0e0e] text-white rounded-lg p-3 text-sm mb-4 focus:outline-none focus:ring-2 focus:ring-[#00C2CB]"
          rows={4}
          value={message}
